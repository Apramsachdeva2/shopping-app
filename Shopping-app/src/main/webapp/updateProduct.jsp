...
<h1 align="center" style="color: #00ffff; font-size:50px;">Update Products</h1>
<div align="right">
<a href="admin">
...
<div align="center">
<form:form modelAttribute="product" method="post" action="changeProduct">
...
<input type="submit" name="submit" value="Update Product" style="background-color: #42f5da; font-size: 15px;" />
